...
Foundation, Inc., 51 Franklin St, Fifth Floor, Boston, MA  02110-1301  USA
	-->
<xsl:stylesheet xmlns:exfk="http://kuberam.ro/exsltforms" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ev="http://www.w3.org/2001/xml-events" xmlns:exslt="http://exslt.org/common" xmlns:xforms="http://www.w3.org/2002/xforms" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.0" exclude-result-prefixes="xhtml xforms ev">
    ...
    <xsl:template name="eXSLTForms">
        <xsl:variable name="exsltformsBaseURI">
            <xsl:value-of select="exslt:node-set($eXSLTFormsConfigOptions)/eXSLTFormsConfigOptions/eXSLTFormsBaseURI"/>
        </xsl:variable>
